...
class IgnisBotMove(object):
    ...
    def normalise_angles(self, angle, servo_name):
        ...
        """
        print("normalise_angles")
        print("angle="+str(angle))
        print("servo_name="+str(servo_name))
        if servo_name in self.SERVO_RANGES:
            ...
            print("Servo exist==>"+str(servo_name)+", clamped="+str(normalised_angle))
        else:
            print("Servo doesnt exist==>"+str(servo_name))
